...
table.tablesearch
{
  ...
  <title>INVENTORY / TOTAL STOCKS</title>
</head>
...
<div style="background-color: lightgray;padding:0px 0px;width:100%">
      ...
      <a href="inventoryin.php"><button class="tablinks  ">
        ...
        <a href="inventorystocks.php"><button class="tablinks  branchess">
    ...
    <div class="col-md-12 ">
            <table id="example" class="table table-striped table-bordered cl" style='width:100%'>
              ...
              <?php 
                //  include('connection/data.php');
                $displayy=mysqli_query($con,"SELECT ii.item_id,i.name,i.brand, SUM(ii.quantity)AS quantity  from inventory_in ii
                INNER JOIN items i ON ii.item_id=i.id WHERE ii.quantity>0
                GROUP BY ii.item_id,i.name,i.brand "); 
