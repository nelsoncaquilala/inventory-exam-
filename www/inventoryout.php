...
table.tablesearch
{
  ...
  <title>INVENTORY / INVENTORY_OUT</title>
</head>
...
<?php
  if($role=='staff')
      ...
      <div id="inventory" class="tabcontent">
          <div style="background-color: lightgray;padding:0px 0px;width:100%">
            ...
            <a href="inventoryin.php"><button class="tablinks  ">
              ...
              <a href="inventoryout.php"><button class="tablinks  branchess">
    ...
    <div class="col-md-12 "><button class='btn btn-success btn-sm clicksearch'>Search Item <strong> &nbsp;[ F5 ]</strong></button><br><br>
            <table id="example" class="table table-striped table-bordered cl" style='width:100%'>
              ...
              <?php 
                //  include('connection/data.php');
                $displayy=mysqli_query($con,"SELECT * from inventory_out "); 
